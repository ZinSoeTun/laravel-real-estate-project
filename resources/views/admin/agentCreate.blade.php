...
@section('title', 'Create Agent Page')
@section('content')
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item">Agent</li>
      <li class="breadcrumb-item active text-primary" aria-current="page">Create Agent</li>
    </ol>
  </nav>
  <main>
       {{-- agent create --}}
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h3 class="text-center">Create New Agent</h3>
                    </div>
                    {{-- horizontal line --}}
                    <br>
                    {{-- agent form --}}
                    <form action="{{route('admin.agent.agentCreate')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        {{-- agent name --}}
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="agentName"
                                ...
                                placeholder="agent name" value="{{ old('agentName') }}">
                            @error('agentName')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="agentEmail"
                                ...
                                placeholder="agent email" value="{{ old('agentEmail') }}">
                            @error('agentEmail')
                                <div class="text-danger">
                                    *{{ $message }}
                                </div>
                           ...
                           <div class="form-group mb-3">
                            ...
                            <input type="text" name="agentPhone"
                                ...
                                placeholder="agent phone mumber" value="{{ old('agentPhone') }}">
                            @error('agentPhone')
                                <div class="text-danger">
                                    *{{ $message }}
                                </div>
                           ...
                           <div class="form-group mb-3">
                            ...
                            <input type="text" name="agentAddress"
                                ...
                                placeholder="agent address" value="{{ old('agentAddress') }}">
                            @error('agentAddress')
                                <div class="text-danger">
                                    *{{ $message }}
                                </div>
                          ...
                          <div class="form-group mb-3">
                            ...
                            <input type="text" name="language"
                                ...
                                placeholder="agent can speak language" value="{{ old('language') }}">
                            @error('language')
                                <div class="text-danger">
                                    *{{ $message }}
                                </div>
                          ...
                          <div class="form-group mb-3">
                            ...
                            <input type="text" name="citizen"
                                ...
                                placeholder="citizen" value="{{ old('agcitizen') }}">
                            @error('agcitizen')
                                <div class="text-danger">
                                    *{{ $message }}
                                </div>
