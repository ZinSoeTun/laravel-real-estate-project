                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link one active" data-bs-toggle="tab" id="1">Overview</button>
                            </li>

                            <li class="nav-item">
                                <button class="nav-link two" data-bs-toggle="tab" id="2">Edit
                                    Profile</button>
                            </li>

                            <li class="nav-item">
                                <button class="nav-link three" data-bs-toggle="tab" id="3">Change
                                    Password</button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="{{route('admin.profile.saveChange')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    {{-- image upload --}}
                                    <div class="mb-3 row">
